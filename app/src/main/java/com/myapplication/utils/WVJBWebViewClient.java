...
//    private Map<String,CallBackFunction> responseCallbackss =null;
//    private Map<String,BridgeHandler> messageHandlerss = null;
...
//        this.responseCallbackss = new HashMap<>();
//        this.messageHandlers = new HashMap<String, WVJBHandler>();
//        this.messageHandlerss = new HashMap<>();
...
//        if (handlerName == null || handlerName.length() == 0 || handler == null)
//            return;
//        messageHandlerss.put(handlerName, handler);
//    }
//
...
//                            responseCallbackss.remove(message.responseId);
//                    if (responseCallback != null) {
//                        responseCallback.callback(message.responseData);
//                    }
//                    if(callBackFunction != null){
//                        callBackFunction.onCallBack(message.responseData.toString());
//                    }
//
//
//                } else {
...
//
//                    WVJBHandler handler;
//                    BridgeHandler bridgeHand = null;
//                    if (message.handlerName != null) {
//                        handler = messageHandlers.get(message.handlerName);
//                        bridgeHandler = messageHandlerss.get(message.handlerName);
//                    } else {
//                        handler = messageHandler;
//                        bridgeHand = bridgeHandler;
//                    }
//                    if (handler != null) {
//                        handler.request(message.data, responseCallback);
//                    }
//                    if(null !=bridgeHand){
//                        bridgeHand.handler(message.data.toString(),callBackFunction);
//                    }
//                }
//            }
//        } catch (JSONException e) {
